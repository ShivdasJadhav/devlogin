          ...
          {articles.map((post) => (
            <li key={post._id}>
              <div class="mb-6 lg:mb-0">
                <div class="relative block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] border">
                  <div class="flex">
                    <div
                    ...
                    >
                      <img src={post.media} class="w-full border border-2" />
                      <a href="#!">
                  ...
                  <div class="p-6">
                    <h5 class="mb-3 text-sm font-bold">{post.title}</h5>
                    ...
                    <p class="mb-4 pb-2 text-xs">{post.excerpt}</p>
                    <div className="flex justify-between">
                      <a
                        href={post.link}
                        data-te-ripple-init
                        data-te-ripple-color="light"
                        class="inline-block rounded-full bg-blue-400 bold text-white px-5 pt-2 pb-1 text-xs font-medium uppercase leading-normal "
                      >
                        Read more
                      </a>
