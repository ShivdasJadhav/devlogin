const Prising=()=>{
    return(
        <section id='pricing' className="text-gray-600 h-fit body-font overflow-hidden">
  <div className="container px-5 py-24 mx-auto">
    ...
    <div className="flex flex-wrap mx-auto p-6 -m-4">
      ...
      <div className="p-4 xl:w-1/4 md:w-1/3 w-full">
        <div className="h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden">
          <h2 className="text-sm tracking-widest title-font mb-1 font-medium">Community</h2>
          <h1 className="text-5xl text-gray-900 leading-none flex items-center pb-4 mb-4 border-b border-gray-200">
            <span>$66</span>
            <span className="text-lg ml-1 font-normal text-gray-500">/mo</span>
          </h1>
